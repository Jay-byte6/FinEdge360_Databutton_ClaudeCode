      ...
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-xl md:text-2xl">
          ...
          <span className="font-extrabold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
            🛣️ Your Financial Roadmap
          </span>
        </CardTitle>
        <CardDescription className="text-sm md:text-base font-medium">Your personalized journey to financial independence</CardDescription>
      </CardHeader>
      <CardContent>
        {/* Summary Stats */}
