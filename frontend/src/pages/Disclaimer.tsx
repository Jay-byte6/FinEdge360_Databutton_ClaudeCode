        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-900 font-semibold">
                    FIREMap is an EDUCATIONAL financial planning tool. We do NOT provide
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                <p>FIREMap is a self-service educational platform that provides:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p className="mt-3">
                  ...
                  FIREMap is not responsible for any financial losses you may incur.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                <p>
                  FIREMap may contain links to third-party websites, resources, or educational content.
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                <p className="font-semibold">
                  To the maximum extent permitted by law, FIREMap and its affiliates shall NOT be
                  liable for:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                <p>
                  FIREMap is an educational tool compliant with SEBI regulations as a self-service
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                <p className="font-semibold">
                  By using FIREMap, you acknowledge and accept that:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>You will not rely solely on FIREMap for investment decisions</li>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-red-900">
                    ...
                    {' '}FIREMap is an educational tool, NOT a substitute for professional financial advice.
                  ...
                  <p className="text-red-900 mt-3 font-semibold">
                    By using FIREMap, you accept full responsibility for all financial decisions
                    and agree that FIREMap is not liable for any losses you may incur.
                  </p>
                </div>
              </div>
            </div>
