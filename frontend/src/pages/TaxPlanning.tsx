...
import { Info } from 'lucide-react'; // Added for Info icon
        ...
        <Card className="bg-gradient-to-r from-orange-50 to-red-50 border-2 border-orange-300 shadow-lg">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              {/* Scenario 1: Tax Savings Investment */}
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-amber-50 p-3 rounded border border-amber-200">
                    ...
                    <p className="text-amber-800 text-xs">
                      Invested @ 12% for 5 years: <strong>₹{formatCurrency(10000 * ((Math.pow(1 + 0.12/12, 5*12) - 1) / (0.12/12)))}</strong>
                    </p>
                    <p className="text-amber-800 text-xs mt-1">
                      Invested @ 12% for 10 years: <strong>₹{formatCurrency(10000 * ((Math.pow(1 + 0.12/12, 10*12) - 1) / (0.12/12)))}</strong>
                    </p>
                  </div>
                </div>
              </div>
